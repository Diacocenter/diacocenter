...
import logo from "./assets/logo-navbar-seeker.png";
...
const menuItem = [
    ...
    {
        id: 2,
        path: "/technology-seeker-panel/account-info",
        name: "Account info",
        icon: PersonIcon,
        hasChildren: true,
        children: [
            {
                ...
                path: "/technology-seeker-panel/account-info/contact-detail",
            },
            {
                name: "Social Address",
                path: "/technology-seeker-panel/account-info/social-address",
            },

            {
                name: "My Documents",
                path: "/technology-seeker-panel/account-info/documents",
            },
            {
                name: "Education",
                path: "/technology-seeker-panel/account-info/education",
            },
            {
                name: "Experience",
                path: "/technology-seeker-panel/account-info/experience",
            },
        ],
    },
    {
        id: 3,
        path: "/technology-seeker-panel/project",
        name: "Projects",
        ...
        children: [
            {
                name: "Applied",
                path: "/technology-seeker-panel/project/applied/",
            },
            {
                name: "Accepted",
                path: "/technology-seeker-panel/project/accepted/",
            },
            {
                name: "Completed",
                path: "/technology-seeker-panel/project/completed/",
            },
        ],
    },
    {
        id: 4,
        path: "/technology-seeker-panel/discover",
        name: "Discover",
        icon: ExploreIcon,
        hasChildren: false,
    },
    {
        id: 5,
        path: "/technology-seeker-panel/agreement",
        name: "Agreements",
        icon: HandshakeIcon,
        hasChildren: false,
    },
    {
        id: 6,
        path: "/technology-seeker-panel/wallet",
        name: "Wallet",
    ...
    {
        id: 7,
        path: "/technology-seeker-panel/communications",
        name: "Communications",
    ...
    // {
    //     id: 8,
    //     path: "/technology-seeker-panel/setting",
    //     name: "Setting",
    //     icon: SettingsIcon,
    //     hasChildren: false,
    // },
...
export default function MainDrawer() {
    ...
    const GeneralInfo = useQuery('GeneralInfo', async () => {
        const {data} = await axios.get(route("api.web.v1.technology-seeker-panel.general-info"));
                        ...
                        >
                                            ...
                                            <MenuList dense>
                                                ...
                                                <Box className="scrollbar"
                                                    ...
                                                    {Data.data.unread.map((item) => (
                                                        <Box key={item.id}>
                                                            <Link to={`/technology-seeker-panel/communications?q=${item.id}`}>
                                                            <MenuItem>
                                                                <Avatar
                                                                    alt="Avatar Pic"
                                                                    src={
                            ...
                            sx={{ maxHeight: "14rem", overflowY: "scroll" }} >
                                ...
                                >
                                    ...
                                    <MenuItem sx={{ p: 0 }}>
                                        {/* <Link component={Link} to={"/technology-provider-panel/setting"}> */}
                                        <ListItemButton
                                            component={Link}
                                            to={
                                                "/technology-seeker-panel/setting"
                                            }
                                        >
                                            <Box
                                                sx={{
                                    ...
                                    >
                                        <Link to={"/technology-seeker-panel/communications"}>
                                            <Badge
                                                badgeContent={Object.values(Data.data.unread).length}
                                                color="error"
                                                sx={{ mx: 2 }}
