{{--<picture>--}}
{{--    <source class="w-70 d-block m-auto"--}}
{{--            srcset="{{asset("storage/contact-us/map.png")}}">--}}
{{--    <img class="w-100 h-100" src="{{asset("storage/contact-us/map.webp")}}">--}}
{{--</picture>--}}
...
<div class="h-[30rem] relative font-piazzolla">
