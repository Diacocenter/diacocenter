...
const menuItem = [
    ...
    {
        id: 2,
        path: "/advisor-panel/account-info",
        name: "Account info",
        icon: PersonIcon,
        hasChildren: true,
        children: [
            {
                ...
                path: "/advisor-panel/account-info/contact-detail",
            },
            {
                name: "Social Address",
                path: "/advisor-panel/account-info/social-address",
            },

            {
                name: "My Documents",
                path: "/advisor-panel/account-info/documents",
            },
            {
                name: "Education",
                path: "/advisor-panel/account-info/education",
            },
            {
                name: "Experience",
                path: "/advisor-panel/account-info/experience",
            },
        ],
    },
    {
        id: 3,
        path: "/advisor-panel/project",
        name: "Projects",
    ...
    {
        id: 7,
        path: "/advisor-panel/communications",
        name: "Communications",
