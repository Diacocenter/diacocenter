...
export default function ChatComponent(props){
    ...
    const ChatComponent = useMutation(async (data) => {
        const response = await axios.put(route("api.web.v1.technology-seeker-panel.communication.update",{communication:props.id}), data);
    ...
    return(
        <>
            <Box  className="scrollbar"  sx={{ flexGrow: 0, mx:1 }}>
                ...
                <Box
                    ...
                    <TextField size="small" id="message" {...register("message")} fullWidth placeholder="Type your message" variant="outlined" InputProps={{
                        endAdornment: (<InputAdornment position="end">
                                <IconButton sx={{ ml: 0.5 }} edge="end" value={props.id} {...register("communication")}>
