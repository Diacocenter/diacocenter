...
@section('content')
    <div class="container mt-10 mx-auto font-piazzolla px-5">
        <div>
            <picture>
                <source class="w-100"
                        srcset="{{ asset('/storage/articles/header') . '/' . $article->headerImage()->first()->url . '.png' }}">
                <img class="w-100"
                     src="{{ asset('/storage/articles/header') . '/' . $article->headerImage()->first()->url . '.webp' }}">
            </picture>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-4 mt-10">
            ...
            <div class="col-span-1 pl-10 lg:border-l">
                <div>
