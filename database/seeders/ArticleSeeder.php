...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $items = [
            [
                "title"             => "What is Diaco Center",
                "body"              => '<div><div class=""><p class="text-h1 my-2">What is Diaco Center</p><p class="my-8">As we mentioned in the article what is Diaco Center, Diaco Center is an intermediary company between technology seekers and technology providers. In this company, we are trying to make useful connections between technology seekers and technology providers. Do you know How Diaco Center works? In this article, we will tell you everything about Diaco Center and the way of its working. <br> So, stick around till the end of the article.</p></div><div class="px-10"><p class="text-h3 my-2">Who are technology Seekers</p><p class="text-body1 my-8">Technology seeker refers to individuals or businesses which are actively searching for technology solutions to meet their specific needs or challenges. A group of people who need new technology to boost their business, So they need a professional group to provide new technology for them.</p></div><div class="px-10"><p class="text-h3 my-2">Who are technology Providers</p><p class="text-body1 my-8">a technology provider is an individual, organization or company that offers technology solutions and creates new technologies to meet the needs of the projects. Technology providers play an important role in delivering technology solutions that solve the specific challenges of technology seekers. They offer their profession and services to help businesses improve and boost their business.</p></div><div class=""><p class="text-h2 my-2">Membership in Diaco Center system</p><p class="text-body1  my-8">As we the first step to cooperate with Diaco Center is to complete the registration process in the system. You can contact our experts to get information and registration guides. As we mentioned, everything that is needed for you to be a part of our company and expand your business is to fill out the registration form on our website and complete your profile information. <br><a href="#" class="text-primary">Link</a></p></div><div class=""><p class="text-h2 my-2">Project registration steps of Diaco Center</p><p class="text-body1  my-8">Depending on your role as a technology seeker or technology provider, you have a different registration process. If you are a technology seeker, you must completely explain your project, your condition, your issue and everything about your needed technology. But if you are a technology provider, you should complete your profile and all of the information related to your knowledge and expertise. The more accurate and detailed information you provide, it will be easier for technology seekers to find you. <br><a href="#" class="text-primary">Click here to register and complete your profile.</a></p></div><div class="px-10"><p class="text-h3 my-2">Fill out your profile in Diaco Center</p><p class="text-body1  my-8">Complete your profile carefully so the artificial intelligence(AI) can provide you better offers based on your expertise. Try to mention different fields of your business and everything that you want to be provided.<br><a href="#" class="text-primary">Fill out Your Profile</a></p></div><div class=""><p class="text-h2 my-2">Diaco Center works on</p><p class="text-body1  my-8">Diaco Center works on various items which include assistance with contracts, negotiations, payments, and technical support and consultation. In the rest of the article, for a better understanding, we will explain each one separately.</p></div><div class="px-10"><p class="text-h3 my-2">Diaco Center works on negotiations</p><p class="text-body1  my-8">Diaco Center acts as a neutral intermediary element between both parties of the contract. This company acts like a supervisor and tries to resolve the disputes between the parties involved in negotiations.</p></div><div class="px-10"><p class="text-h3 my-2">Diaco Center works on payments</p><p class="text-body1  my-8">Diaco Center tries to make you feel sure about the security of your payments. With Diaco Center, you can do your transactions without any worries. Everybody knows that technology costs can be high and conducting transactions and payments can involve high risks. Therefore, we need a platform which allows us to deposit or receive our payments with the highest level of security. Diaco Center is the best platform to meet these needs.</p></div><div class="px-10"><p class="text-h3 my-2">Diaco works on technical support</p><p class="text-body1  my-8">Diaco goes along in all steps of your activity, whether you join as a technology provider, a technology seeker or even as an ordinary person seeking to enhance their experience or knowledge. In all of these situations, Diaco assists you with its team of professional experts. We assure you, that wherever you need specialized consultation, our Specialists will help you and never leave you in this challenging route. Trust us and leave your business and technology development to us. <br><a href="#" class="text-primary">Contact Us</a></p></div></div>',
