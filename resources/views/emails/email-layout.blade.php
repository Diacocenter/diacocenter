...
<table border="0" align="center" cellpadding="0" cellspacing="0" width=600 style="width: 600px;max-width:600px;font-family: 'Roboto', sans-serif;">
    <tr>
        <td>
    ...
    <tr>
        <td>
            @includeIf("emails.components.our-project")
        </td>
    </tr>
    <tr>
        <td>
