<div class="container font-piazzolla">
    <div class="md:border-l-2 border-black mt-10 flex gap-5" id="our-story-content">
        <div class="relative hidden md:block p-0 ">
            <div class="sticky overflow-hidden top-0">
                <div class="relative -left-8">
                    <picture>
                        <source  srcset="{{asset("/storage/website/our-story/circle.png")}}" >
                        <img id="diaco-circle" class="max-w-none" src="{{asset("/storage/website/our-story/circle.webp")}}" alt="circle">
                    </picture>
                    <h1 id="year" class="text-h3 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">2012</h1>
                </div>
            </div>
        </div>
        <div class="">
            ...
            <div class="grid grid-cols-1">
                ...
                <div class="mt-16">
                    ...
                    <ul class=" mt-8 text-body1 list-disc list-inside">
                        <li> An organized group of searchers
                        </li>
                        <li> Technology suppliers
                        </li>
                        <li> Multiple accomplished endeavors
                        </li>
                        <li> Managing numerous concurrent initiatives
                        </li>
                    </ul>
                </div>
            </div>
